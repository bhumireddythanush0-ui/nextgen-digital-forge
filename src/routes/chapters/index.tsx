    ...
    <div className="min-h-screen bg-[#fbfbfd] text-slate-950">
      ...
      <main className="px-4 pb-24 pt-32 sm:px-6 sm:pt-36 lg:px-8">
        <section className="mx-auto max-w-7xl">
          <div className="relative overflow-hidden rounded-[32px] bg-[#081225] px-6 py-12 text-white sm:rounded-[36px] sm:px-10 sm:py-16 lg:px-14">
          ...
          {filteredChapters.length > 0 ? (
            <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {filteredChapters.map((chapter) => (
                <article
                  key={chapter.slug}
                  className="group flex min-h-[340px] flex-col rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_20px_65px_-48px_rgba(15,23,42,0.6)] transition duration-300 hover:-translate-y-1.5 hover:border-blue-200"
                >
